...
// export interface itemDataStateProps{
//   date: Date,
//     itemData:{
//     amountNumber: Number,
//     categoryText: '',
...
const DashBoardHome: React.FC<Props> = ({ props, navigation }) => {
  ...
  const handleSearchButton = () => {
    ...
    if (!connectionStatusState) {
      ...
      return navigation.navigate('ItemListTab.tsx');
    } else {
      // console.log('searchStringState: ',searchStringState);
      // setSearchString
  ...
  if (
    ...
    return (
      <View style={DashBoardStyles.MonosHomePageFullViewWithStatusBar}>
        <SafeAreaView style={DashBoardStyles.safeAreaViewcontainer}>
          <StatusBar backgroundColor="#FFFFFF" barStyle="dark-content" />
          <View style={DashBoardStyles.MonosHomePageFullViewWithOutStatusBar}>
            <View
              style={{
                flex: 2.9,
